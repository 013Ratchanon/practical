...
<body>
    ...
    $sql = "SELECT * FROM queue ORDER BY  QNumber";
    ...
    if (isset($_POST['QDate'])) {
        if (!empty($_POST['QNumber']) && !empty($_POST['Pid'])) {
            ...
            $sql = "insert into queue (QDate,QNumber,Pid,QStatus)
        ...
        <div class="row">
            <div class="col-md-4"> <br>
                ...
                <form action="AddQueue.php" method="POST" enctype="multipart/form-data">
                    ...
                    <br>
                    <input type="text" placeholder="รหัสบัตรประชาชน" name="Pid" class="form-control">
                    <br>
